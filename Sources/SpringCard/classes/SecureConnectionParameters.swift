...
@objc public class SecureConnectionParameters: NSObject {
    /// Authentication mode
    ...
    @objc public init(authMode: AuthenticationMode, keyIndex: KeyIndex, keyValue: [UInt8], commMode: CommMode, debugSecureCommunication: Bool) {
